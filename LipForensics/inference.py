...
import sys
sys.path.insert(0, "/root/LipForensics/data")
from transforms import NormalizeVideo, ToTensorVideo
from dataset_clips import ForensicsClips, CelebDFClips, DFDCClips, SingleVideoClips
from samplers import ConsecutiveClipSampler
sys.path.insert(0, "/root/LipForensics/models")
...
def evaluate_lipforensics(
    cropped_mouths_path,
    weights_forgery_path="/root/LipForensics/models/weights/lipforensics_ff.pth",
    frames_per_clip=25,
    batch_size=8,
    device="cuda:0",
    grayscale=True,
