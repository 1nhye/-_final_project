...
import sys
sys.path.insert(0, "/root/THEORY-AND-PRACTICE-OF-DEEP-LEARNING_final_project/LipForensics")
from inference import evaluate_lipforensics
sys.path.insert(0, "/root/THEORY-AND-PRACTICE-OF-DEEP-LEARNING_final_project/25th-conference-fakebusters/model/roi_extractor/utils")
from preprocess import VideoROIExtractor  # VideoROIExtractor 클래스 불러오기
